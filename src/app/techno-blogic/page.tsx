  ...
  return (
    <div className="min-h-screen p-8 max-w-6xl mx-auto">
      <div className="mb-10 justify-center"> 
        ...
        {mappedData.length > 0 ? <div className={postLayout === 'grid' ? 'grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8' : 'space-y-6'}>
          {mappedData.map((post) => (
            postLayout === 'grid' ? (
              <BlogCard
                key={post.id}
        ...
        </div> : <div className="min-h-screen flex items-center justify-center bg-black text-white">
